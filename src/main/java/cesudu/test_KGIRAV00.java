...
import DataSet_package.IDS_KGIRAV00;
...
public class test_KGIRAV00 {

	public static void doit(String fileName) {
		// TODO Auto-generated method stub
		System.out.println("****矩阵形式-知识粒度（原）******"+fileName+"上KGIRA的运行时间"+"***********");
		...
		// 创建DataPreprocess对象data1        
	       ...
	       IDS_KGIRAV00 im2=new IDS_KGIRAV00();
		   ...
		   while (value.hasNext()) {
				...
				preRED.clear();preRED.addAll(nowRED);
				k++;
